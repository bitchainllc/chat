...
bot.start((ctx) => {
  ctx.reply(
    "\nAsk anything using /sense followed by your question, if your directly texting the bot you don't need to use /sense, just ask your question."
  );
});
...
bot.command("sense", async (ctx) => {
  ...
  if (question.length == 0) {
    return ctx.reply("Type something after /sense to ask me stuff.", {
